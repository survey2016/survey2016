              ...
              <table id="dataTables" class="table m-b-none" style="border:none" ui-jq="footable" data-filter="#filter" data-page-size="5">
                <thead>
                  <tr>                      
                      ...
                      <th data-toggle="true">Province</th>
                      <th data-toggle="true">District</th>
                      <th data-toggle="true">Town</th>
                      <th data-toggle="true">Brgy</th>     
                      <th >Action</th>
                  </tr>
                </thead>
                <tbody>
                  <?php foreach ($results as $res) { ?>
                    <tr>
                      ...
                      <td class="text-center">{{ $res->provinceID }}</td>
                      <td class="text-center">{{ $res->districtID }}</td>
                      <td class="text-center">{{ $res->townID }}</td>
                      <td class="text-center">{{ $res->brgyID }}</td>
                      <td>
