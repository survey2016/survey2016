...
<div class="container w-xxl w-auto-xs" ng-controller="SigninFormController" ng-init="app.settings.container = false;">
  ...
  <div class="m-b-lg">
    <div class="wrapper text-center">
      <strong>The email <br><br> <b style="color:orange">{{ $theEmail }}</b> <br> <br> is already in use. <br><br>
        <a href="/register" class="btn btn-lg btn-default btn-block">Try again?</a>
      </strong>
    </div>
  </div>
