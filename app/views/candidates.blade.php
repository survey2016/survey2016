              ...
              <table id="dataTables" class="table m-b-none" style="border:none" ui-jq="footable" data-filter="#filter" data-page-size="5">
                <thead>
                  <tr>
                      ...
                      <th data-toggle="true">Survey 1</th>
                      <th data-toggle="true">Survey 2</th>
                      <th data-toggle="true">Survey 3</th>
                      <th data-toggle="true">Survey 4</th>
                ...
                <tbody>
                  <?php foreach ($results as $res) { ?>
                    <tr>
                      <td>{{ strtoupper($res->lastName) }}, {{ ucwords($res->firstName) }}</td>
                      <td class="text-center">{{ $res->survey1 }}</td>
                      <td class="text-center">{{ $res->survey2 }}</td>
                      <td class="text-center">{{ $res->survey3 }}</td>
                      <td class="text-center">{{ $res->survey4 }}</td>
                      <td>
